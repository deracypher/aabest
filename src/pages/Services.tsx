...
import { 
  Sparkles, Heart, Home, Brain, Clock, Car, 
  CheckCircle, ArrowRight, Activity, Pill, Stethoscope, HeartPulse
} from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    includes: [
      ...
      "Playing games, puzzles, and brain-stimulating activities",
      "Reading together or audiobooks",
      "Arts and crafts activities",
      "Music therapy and reminiscence",
      "Walking and light exercise",
      "Accompanying to social events and appointments",
  ...
  },
  {
    ...
    includes: [
      "Dementia & Alzheimer's care with memory support",
      "Diabetes care and monitoring",
      "Heart disease support",
      "COPD and respiratory assistance",
    ...
    specializations: [
      { icon: Brain, title: "Dementia & Alzheimer's Care", desc: "Memory support and cognitive engagement" },
      { icon: Activity, title: "Chronic Condition Management", desc: "Diabetes, heart disease, COPD support" },
      { icon: Stethoscope, title: "Post-Surgical & Recovery Care", desc: "Wound care and mobility restoration" },
      { icon: HeartPulse, title: "Palliative & End-of-Life Care", desc: "Comfort-focused compassionate support" },
    ],
  },
  {
    id: "respite",
    ...
    includes: [
      "Short-term care coverage (hours to weeks)",
      "Flexible scheduling to match your needs",
      "Familiar caregivers for consistency",
  ...
  },
  {
    ...
    image: serviceLivein,
    includes: [
      "Overnight presence and monitoring",
          ...
          <div className="flex gap-2 min-w-max">
            {services.map((service) => (
              <a
                key={service.id}
                href={`#${service.id}`}
                className="px-4 py-2 rounded-full text-sm font-medium bg-muted text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-colors whitespace-nowrap"
              >
                ...
                {service.specializations && (
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    {service.specializations.map((spec) => (
                      <div key={spec.title} className="bg-card rounded-lg p-4 border border-border">
