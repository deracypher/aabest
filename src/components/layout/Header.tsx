...
const navItems = [
  ...
  { name: "About Us", href: "/about" },
  {
    ...
    dropdown: [
      ...
      { name: "Homemaking", href: "/services#homemaking" },
  ...
  return (
    <header
      className={cn(
        ...
        isScrolled ? "bg-card shadow-nav py-2" : "bg-card/95 backdrop-blur-sm py-4"
      )}
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            >
              ...
              <span className="text-sm">(403) 123-4567</span>
            </a>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden mt-4 pb-4 border-t border-border pt-4 animate-fade-in">
            ...
            <div className="mt-4 pt-4 border-t border-border space-y-3">
              <a
                href="tel:+14031234567"
                className="flex items-center gap-2 text-secondary font-semibold px-4"
              >
                <Phone className="w-4 h-4" />
